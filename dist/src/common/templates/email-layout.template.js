...
exports.nl2br = exports.escapeHtml = exports.defaultAccent = void 0;
exports.renderEmailLayout = renderEmailLayout;
exports.defaultAccent = '#1f7ae0';
...
const nl2br = (value) => (0, exports.escapeHtml)(value)
    .split('\n')
    .map((line) => (line.trim() ? `<p class=\"p\">${line}</p>` : '<div style=\"height:10px;\"></div>'))
    .join('');
exports.nl2br = nl2br;
function renderEmailLayout(params) {
    const { preheader, eyebrow, title, subtitle, accent = exports.defaultAccent, contentHtml, contactEmail, footerNote, } = params;
    return `
<!DOCTYPE html>
<html lang="en">
<head>
