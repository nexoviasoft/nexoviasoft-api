...
exports.getInterviewInvitationTemplate = getInterviewInvitationTemplate;
const email_layout_template_1 = require("./email-layout.template");
function getInterviewInvitationTemplate(candidateName, position, type, date, time, interviewer, meetLink, contactEmail) {
    const contentHtml = `
...
//# sourceMappingURL=interview-invitation.template.js.map